	...
	return (
		<>
			<div className="w-full min-h-[100vh] bg-[#090c10] ">
				<div className="headermodifier  p-4 px-10 w-full flex justify-between items-center h-[120px] gap-[40px] ">
				...
				<div className="grid-container flex justify-center mt-[20px]">
					<div className="bento-grid">
						...
						<div className="map p-0 relative">
							<div className="absolute top-3 left-3 bg-slate-800 px-[15px] py-[10px]  rounded-3xl h-[60px] flex items-center">
								I am From Kalaburagi Karnataka
							</div>
							<iframe
						...
						<div className="work  an54 relative overflow-hidden">
							...
							<img
								src={projects}
								className="absolute bottom-[60px]  rotate-[-45deg] scale-[1.5] "
							/>
						</div>
						...
						<div className="social">
							<Link to="https://www.instagram.com/sahil_mengji/">
								<svg
									className="div4"
									xmlns="http://www.w3.org/2000/svg"
									x="0px"
							...
							<Link to="https://github.com/sahil-mengji">
								<svg
									className="div2"
									xmlns="http://www.w3.org/2000/svg"
									x="0px"
							...
							<Link to="https://twitter.com/MengjiSahil">
								<svg
									className="div1"
									xmlns="http://www.w3.org/2000/svg"
									x="0px"
